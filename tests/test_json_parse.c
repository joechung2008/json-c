...
static void test_parse_simple(void **state)
{
    ...
    assert_non_null(v);
    const char *raw = json_text(v);
    assert_non_null(raw);
    assert_string_equal(raw, text);
    json_free(v);
}
...
static test_entry_t all_tests[] = {
    {"test_parse_array_and_values", test_parse_array_and_values},
    {"test_parse_array_empty_and_numbers", test_parse_array_empty_and_numbers},
    {"test_parse_array_empty_type", test_parse_array_empty_type},
    {"test_parse_array_missing_opening_bracket", test_parse_array_missing_opening_bracket},
    {"test_parse_array_mixed_types", test_parse_array_mixed_types},
    {"test_parse_array_nested_and_mixed", test_parse_array_nested_and_mixed},
    {"test_parse_array_nested_first_element", test_parse_array_nested_first_element},
    {"test_parse_array_nested_second_element", test_parse_array_nested_second_element},
    {"test_parse_array_of_strings_and_booleans", test_parse_array_of_strings_and_booleans},
    {"test_parse_array_unexpected_delimiter", test_parse_array_unexpected_delimiter},
    {"test_parse_empty_input", test_parse_empty_input},
    {"test_parse_empty_object", test_parse_empty_object},
    {"test_parse_invalid_input", test_parse_invalid_input},
    {"test_parse_malformed_false_literal", test_parse_malformed_false_literal},
    {"test_parse_malformed_null_literal", test_parse_malformed_null_literal},
    {"test_parse_malformed_true_literal", test_parse_malformed_true_literal},
    {"test_parse_multiple_pairs_and_commas", test_parse_multiple_pairs_and_commas},
    {"test_parse_number_decimal_and_exponent", test_parse_number_decimal_and_exponent},
    {"test_parse_number_integer_and_types", test_parse_number_integer_and_types},
    {"test_parse_number_invalid_cases", test_parse_number_invalid_cases},
    {"test_parse_number_positive_and_negative", test_parse_number_positive_and_negative},
    {"test_parse_number_simple", test_parse_number_simple},
    {"test_parse_object_empty", test_parse_object_empty},
    {"test_parse_object_multiple_pairs_and_keys", test_parse_object_multiple_pairs_and_keys},
    {"test_parse_object_nested_and_mixed", test_parse_object_nested_and_mixed},
    {"test_parse_object_single_and_multiple", test_parse_object_single_and_multiple},
    {"test_parse_object_single_pair", test_parse_object_single_pair},
    {"test_parse_object_unexpected_delimiter", test_parse_object_unexpected_delimiter},
    {"test_parse_pair_errors", test_parse_pair_errors},
    {"test_parse_pair_key_and_value_bool", test_parse_pair_key_and_value_bool},
    {"test_parse_pair_key_and_value_null", test_parse_pair_key_and_value_null},
    {"test_parse_pair_key_and_value_number", test_parse_pair_key_and_value_number},
    {"test_parse_pair_key_and_value_string", test_parse_pair_key_and_value_string},
    {"test_parse_pair_key_value_parsing", test_parse_pair_key_value_parsing},
    {"test_parse_pair_simple", test_parse_pair_simple},
    {"test_parse_pair_value_array_and_object_types", test_parse_pair_value_array_and_object_types},
    {"test_parse_pair_whitespace_handling", test_parse_pair_whitespace_handling},
    {"test_parse_simple_array", test_parse_simple_array},
    {"test_parse_simple_value", test_parse_simple_value},
    {"test_parse_simple", test_parse_simple},
    {"test_parse_string_empty", test_parse_string_empty},
    {"test_parse_string_escapes_backslash_and_slash", test_parse_string_escapes_backslash_and_slash},
    {"test_parse_string_escapes_quotes", test_parse_string_escapes_quotes},
    {"test_parse_string_escapes", test_parse_string_escapes},
    {"test_parse_string_invalid_escape", test_parse_string_invalid_escape},
    {"test_parse_string_invalid_unicode", test_parse_string_invalid_unicode},
    {"test_parse_string_malformed_escape_sequences", test_parse_string_malformed_escape_sequences},
    {"test_parse_string_missing_opening_quote", test_parse_string_missing_opening_quote},
    {"test_parse_string_simple", test_parse_string_simple},
    {"test_parse_string_unicode", test_parse_string_unicode},
    {"test_parse_string_unterminated", test_parse_string_unterminated},
    {"test_parse_unexpected_character", test_parse_unexpected_character},
    {"test_parse_value_array_object_whitespace", test_parse_value_array_object_whitespace},
    {"test_parse_value_array_type", test_parse_value_array_type},
    {"test_parse_value_array_values", test_parse_value_array_values},
    {"test_parse_value_booleans_null", test_parse_value_booleans_null},
    {"test_parse_value_number_and_string", test_parse_value_number_and_string},
};
